 ...
 */
final class Version20220129232743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promo_code (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, subscriber_id INT DEFAULT NULL, created_at DATETIME NOT NULL, code VARCHAR(20) NOT NULL, used TINYINT(1) NOT NULL, discount INT NOT NULL, INDEX IDX_3D8C939EA76ED395 (user_id), INDEX IDX_3D8C939E7808B1AD (subscriber_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE paiement_method DROP token_test, CHANGE name name VARCHAR(60) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement_method ADD token_test VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
